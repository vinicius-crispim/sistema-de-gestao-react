...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		forncotacao.setCotacaocompra(fornecedorcotacao);
		...
		forncotacao1.setCotacaocompra(fornecedorcotacao);
		...
		forncotacao2.setCotacaocompra(fornecedorcotacao2);
		...
		forncotacao3.setCotacaocompra(fornecedorcotacao3);
