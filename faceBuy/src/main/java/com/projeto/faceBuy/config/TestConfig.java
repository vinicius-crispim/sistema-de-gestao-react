...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		f4.setCnpj("12344485611");
		f4.setNome("Pernambucanas");
		f4.setLogin("perna");
		f4.setSenha("bucanas123");
		f4.setEmail("pernabu@gmail.com");
		Cidade c = new Cidade();
		...
		fornecedorrepository.saveAll(Arrays.asList(f, f2, f3,f4));
		c.getFornecedores().add(f);
		c.getFornecedores().add(f2);
		c2.getFornecedores().add(f3);
		e.getCidades().add(c2);
		...
		String datateste2 = "16/11/2021";
		coco.setFuncionario(func4);
		coco.setData(datateste2);
		coco.setStatus("Finalizada");
		CotacaoCompra coco2 = new CotacaoCompra();
		String datateste = "16/11/2021";
		coco2.setFuncionario(func7);
		coco2.setData(datateste);
		coco2.setStatus("Finalizada");
		
		cotacomrepository.save(coco);
		cotacomrepository.save(coco2);
		CotacaoCompra coco5 = new CotacaoCompra();
		String datateste5 = "18/11/2021";
		coco5.setFuncionario(func6);
		coco5.setData(datateste5);
		coco5.setStatus("Pendente");
		
		cotacomrepository.save(coco5);
		CotacaoCompraItem cotaitens17 = new CotacaoCompraItem();
		cotaitens17.setCotacaocompra(coco5);
		cotaitens17.setProduto(p8);
		cotaitens17.setQuantidade(19);
		CotacaoCompraItem cotaitens15 = new CotacaoCompraItem();
		cotaitens15.setCotacaocompra(coco5);
		cotaitens15.setProduto(p6);
		cotaitens15.setQuantidade(27);
		CotacaoCompraItem cotaitens18 = new CotacaoCompraItem();
		cotaitens18.setCotacaocompra(coco5);
		cotaitens18.setProduto(p4);
		cotaitens18.setQuantidade(19);
		CotacaoCompraItem cotaitens16 = new CotacaoCompraItem();
		cotaitens16.setCotacaocompra(coco5);
		cotaitens16.setProduto(p3);
		cotaitens16.setQuantidade(27);
		...
		cotaitensrepository.saveAll(Arrays.asList(cotaitens10,cotaitens9,cotaitens11,cotaitens4, cotaitens5, cotaitens6,cotaitens7,cotaitens8,cotaitens15,cotaitens16,cotaitens17,cotaitens18));
	    ...
	    */
		...
		nf3.setData("22/11/2021");
		nf3.setNum_pedido(45896L);
		nf3.setFornecedor(f3);
		nf3.setPrecoTotal(3226.92);
		nf3.setNum_nota(23);
		nf3.setFuncionario(func8);
		nf3.setHora("09:52");
