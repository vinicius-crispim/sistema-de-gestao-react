                ...
                <tbody>
                    {todas.quantidade.map(x => (
                        <tr key={todas.cotacoes[x].id}>
                            <td className="text-center"><button type="submit" value={todas.cotacoes[x].id} onClick={onSubmit} className=" text-dark text-black btn btn-success btn-lg">Ver Pedido</button></td>
