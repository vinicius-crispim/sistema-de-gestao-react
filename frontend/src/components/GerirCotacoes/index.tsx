                    ...
                    <tbody>
                        {todasfiltradas.quantidade.map(x => (
                            <tr key={todasfiltradas.cotacoes[x].id}>
                                ...
                                <td className="text-center align-middle"><button type="submit" value={todasfiltradas.cotacoes[x].id} onClick={onSubmit} className="btn btn-success btn-lg text-black">
