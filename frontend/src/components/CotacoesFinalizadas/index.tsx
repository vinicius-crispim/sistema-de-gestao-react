...
let todascotacoes = JSON.parse(localStorage.getItem('cotacoesfinalizada') || '{}');
...
console.log(todas.cotacoes);
    return (
        <div className="table-responsive">
            <h3 className="text-center display-4">Verifique as cotacões já finalizadas</h3>
...
export default CotacoesFinalizadas;