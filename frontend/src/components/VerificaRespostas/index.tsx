                ...
                <tbody>
                    {todas.quantidade.map(x => (
                        <tr key={todas.fornecedorCotacaoCompra[x].id}>
                            ...
                            <td className=""><button type="submit" value={todas.fornecedorCotacaoCompra[x].id} onClick={onSubmit} className="text-dark text-black btn btn-success"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="32" fill="currentColor" className="bi bi-zoom-in" viewBox="0 0 16 16">
